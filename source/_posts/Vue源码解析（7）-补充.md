...
![WX20190906-230735@2x](http://114.55.30.96/WX20190906-230735@2x.png)
...
![WX20190906-232213@2x](http://114.55.30.96/WX20190906-232213@2x.png)
...
![WX20190907-125550@2x](http://114.55.30.96/WX20190907-125550@2x.png)

![WX20190907-125619@2x](http://114.55.30.96/WX20190907-125619@2x.png)

变量`lsteners`保存了`data.on`，并将`data.on`指向`data.nativeOn`，然后为组件安装声明周期钩子函数

![WX20190907-133025@2x](http://114.55.30.96/WX20190907-133025@2x.png)

之后创建组件`vnode`，这就是生成的组件`vnode`

![WX20190907-133856@2x](http://114.55.30.96/WX20190907-133856@2x.png)



进入`update`方法，首先是创建`div`占位符，然后遍历`children`，创建子节点，就看一下创建组件`App`的过程，在`createComponent`的时候，会调用子组件的`init`钩子方法

![WX20190907-145809@2x](http://114.55.30.96/WX20190907-145809@2x.png)

最后调用`child.$mount`挂载子组件，在挂载子组件过程中，会先生成子组件`vnode`，之后再挂载。

挂载之前会为元素添加事件了

![WX20190907-151133@2x](http://114.55.30.96/WX20190907-151133@2x.png)
...
![WX20190907-151217@2x](http://114.55.30.96/WX20190907-151217@2x.png)
...
![WX20190907-151354@2x](http://114.55.30.96/WX20190907-151354@2x.png)
...
![WX20190907-151541@2x](http://114.55.30.96/WX20190907-151541@2x.png)
...
![WX20190907-165247@2x](http://114.55.30.96/WX20190907-165247@2x.png)
...
![WX20190907-165937@2x](http://114.55.30.96/WX20190907-165937@2x.png)

触发`App`组件的`click`事件，不过触发之前，先回从`_vm`上取`clickHandler`，所以走到了`get`

![WX20190907-170314@2x](http://114.55.30.96/WX20190907-170314@2x.png)
...
![WX20190907-171130@2x](http://114.55.30.96/WX20190907-171130@2x.png)
...
![WX20190907-222530@2x](http://114.55.30.96/WX20190907-222530@2x.png)

然后冒泡，触发

![WX20190907-222753@2x](http://114.55.30.96/WX20190907-222753@2x.png)
...
![WX20190906-151714@2x](http://114.55.30.96/WX20190906-151714@2x.png)

当`el`是`input`的时候

![WX20190906-151816@2x](http://114.55.30.96/WX20190906-151816@2x.png)

走进`genData$2`

![WX20190906-152105@2x](http://114.55.30.96/WX20190906-152105@2x.png)
...
![WX20190906-161250@2x](http://114.55.30.96/WX20190906-161250@2x.png)



然后上面`  var dirs = genDirectives(el, state);`返回的`dirs`就是这样的

![WX20190906-161533@2x](http://114.55.30.96/WX20190906-161533@2x.png)
...
![WX20190906-165558@2x](http://114.55.30.96/WX20190906-165558@2x.png)
...
![WX20190906-171617@2x](http://114.55.30.96/WX20190906-171617@2x.png)

走进去`update`方法看下`patch`阶段做了什么，进入`createElm`方法里的`createChildren`方法（这里是创建的是`div`标签的`children`）

![WX20190906-174914@2x](http://114.55.30.96/WX20190906-174914@2x.png)

![WX20190906-172113@2x](http://114.55.30.96/WX20190906-172113@2x.png)

又会走到`createElm`，这里是`input`标签的了

![WX20190906-175418@2x](http://114.55.30.96/WX20190906-175418@2x.png)
...
![WX20190906-180033@2x](http://114.55.30.96/WX20190906-180033@2x.png)
...
![WX20190906-185324@2x](http://114.55.30.96/WX20190906-185324@2x.png)



触发一下绑定`input`事件

![WX20190906-185653@2x](http://114.55.30.96/WX20190906-185653@2x.png)

![WX20190906-185841@2x](http://114.55.30.96/WX20190906-185841@2x.png)
...
![WX20190906-190059@2x](http://114.55.30.96/WX20190906-190059@2x.png)
...
![WX20190907-123004@2x](http://114.55.30.96/WX20190907-123004@2x.png)
...
![WX20190908-233124@2x](http://114.55.30.96/WX20190908-233124@2x.png)

如果`childVal`不是`function`类型就会提示

![WX20190908-233206@2x](http://114.55.30.96/WX20190908-233206@2x.png)

因为：

在组件创建实例做参数合并的时候，看一下`data`，合并参数后返回的是这个方法，其中的`childVal`是`new Vue(options)`，中的`options`中`data`的引用地址

![WX20190908-234713@2x](http://114.55.30.96/WX20190908-234713@2x.png)

然后在`initData`的时候，获取`data`

![WX20190908-234921@2x](http://114.55.30.96/WX20190908-234921@2x.png)

然后我去修改`data`的值

![WX20190908-235121@2x](http://114.55.30.96/WX20190908-235121@2x.png)
...
![WX20190909-082624@2x](http://114.55.30.96/WX20190909-082624@2x.png)

2）子组件初始化的时候，`initEvents`的时候，添加自定义事件进`vm._events`对象

![WX20190909-084215@2x](http://114.55.30.96/WX20190909-084215@2x.png)

![WX20190909-002952@2x](http://114.55.30.96/WX20190909-002952@2x.png)
...
![WX20190909-084428@2x](http://114.55.30.96/WX20190909-084428@2x.png)

![WX20190909-084607@2x](http://114.55.30.96/WX20190909-084607@2x.png)
...
![WX20190909-101749@2x](http://114.55.30.96/WX20190909-101749@2x.png)

当前元素的`children`的值更新了

![WX20190909-102602@2x](http://114.55.30.96/WX20190909-102602@2x.png)

之后再改变另外一个`li`元素的`children`

![WX20190909-103118@2x](http://114.55.30.96/WX20190909-103118@2x.png)
...
![WX20190909-103558@2x](http://114.55.30.96/WX20190909-103558@2x.png)

所以走进了另外一个处理分支，`sameVnode(oldStartVnode, newEndVnode)`返回为`true`，把现有元素通过`insertBefore`移动到前面

![WX20190909-104124@2x](http://114.55.30.96/WX20190909-104124@2x.png)
...
- 第二个`li`被重新渲染
  ...
  ![WX20190909-125426@2x](http://114.55.30.96/WX20190909-125426@2x.png)

- 第三个`li`被重新渲染

  ![WX20190909-125530@2x](http://114.55.30.96/WX20190909-125530@2x.png)
...
- 第四个`li`的更新内容
  ...
  ![WX20190909-130108@2x](http://114.55.30.96/WX20190909-130108@2x.png)

- 第三个`li`更新内容

  ![WX20190909-130256@2x](http://114.55.30.96/WX20190909-130256@2x.png)
...
![WX20190909-221338@2x](http://114.55.30.96/WX20190909-221338@2x.png)

在`new VueRouter({routes})`的时候，创建路由注册表，下面是创建的实例

![WX20190909-222713@2x](http://114.55.30.96/WX20190909-222713@2x.png)

它的`__proto__`属性：

![WX20190909-225609@2x](http://114.55.30.96/WX20190909-225609@2x.png)
...
![WX20190909-224918@2x](http://114.55.30.96/WX20190909-224918@2x.png)

监听路由变化

![WX20190909-224041@2x](http://114.55.30.96/WX20190909-224041@2x.png)

然后`$route`在这里赋值

![WX20190909-225316@2x](http://114.55.30.96/WX20190909-225316@2x.png)

![WX20190909-225405@2x](http://114.55.30.96/WX20190909-225405@2x.png)
...
![WX20190910-210255@2x](http://114.55.30.96/WX20190910-210255@2x.png)



在`initRender`的时候为子组件`vm`添加`$slots`属性

![WX20190910-204120@2x](http://114.55.30.96/WX20190910-204120@2x.png)
...
![WX20190910-205350@2x](http://114.55.30.96/WX20190910-205350@2x.png)
...
![WX20190910-212407@2x](http://114.55.30.96/WX20190910-212407@2x.png)
...
![微信截图_20190927223928](http://114.55.30.96/%E5%BE%AE%E4%BF%A1%E6%88%AA%E5%9B%BE_20190927223928.png)
...
![微信截图_20190928191902](http://114.55.30.96/%E5%BE%AE%E4%BF%A1%E6%88%AA%E5%9B%BE_20190928191902.png)
...
![微信截图_20190928101915](http://114.55.30.96/%E5%BE%AE%E4%BF%A1%E6%88%AA%E5%9B%BE_20190928101915.png)

之后调用新增这个`wathcer`的`run`方法(最后就是`  vm._update(vm._render(), hydrating);`)，在生成`vnode`的时候，从`cache`中取出缓存的`vnode`

![微信截图_20190928185150](http://114.55.30.96/%E5%BE%AE%E4%BF%A1%E6%88%AA%E5%9B%BE_20190928185150.png)
...
![微信截图_20190928192812](http://114.55.30.96/%E5%BE%AE%E4%BF%A1%E6%88%AA%E5%9B%BE_20190928192812.png)

之后再移除旧的节点

![微信截图_20190928193001](http://114.55.30.96/%E5%BE%AE%E4%BF%A1%E6%88%AA%E5%9B%BE_20190928193001.png)



看一下`componentInstance`在什么时候添加的

![微信截图_20190929010011](http://114.55.30.96/%E5%BE%AE%E4%BF%A1%E6%88%AA%E5%9B%BE_20190929010011.png)
...
![微信截图_20190929235816](http://114.55.30.96/%E5%BE%AE%E4%BF%A1%E6%88%AA%E5%9B%BE_20190929235816.png)
...
![微信截图_20190930000934](http://114.55.30.96/%E5%BE%AE%E4%BF%A1%E6%88%AA%E5%9B%BE_20190930000934.png)
...
![WX20191007-130322@2x](http://114.55.30.96/WX20191007-130322@2x.png)



![WX20191007-130349@2x](http://114.55.30.96/WX20191007-130349@2x.png)



![WX20191007-130403@2x](http://114.55.30.96/WX20191007-130403@2x.png)



![WX20191007-130428@2x](http://114.55.30.96/WX20191007-130428@2x.png)
...
![WX20191024-000600@2x](http://114.55.30.96/WX20191024-000600@2x.png)

![WX20191024-000626@2x](http://114.55.30.96/WX20191024-000626@2x.png)

![WX20191024-000744@2x](http://114.55.30.96/WX20191024-000744@2x.png)
